...
cartRouter.post("/add/:productID", verifyToken, validateProductInfo, cartController.addItemsToCart);
...
cartRouter.put("/inc/",verifyToken, validateCartDefault, cartController.increasedQty);
cartRouter.put("/dec/", verifyToken, validateCartDefault, cartController.decreasedQty);
cartRouter.post("/sync/", verifyToken,validateItemFields, cartController.syncCart);
